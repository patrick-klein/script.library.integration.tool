...
class StagedMovies(object):
    ...
    def view_all(self):
        ...
        '''
        #TODO: add option to remove generated metadata for unstaged/unmanaged items
...
class StagedTV(object):
    ...
    def view_episodes(self, show_title):
        ...
        staged_episodes = self.dbh.get_content_items(status='staged', show_title=show_title,
                                                     order='Title')
